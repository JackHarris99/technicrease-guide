              ...
              <div className="lg:col-span-1 space-y-8">
                ...
                <div className="relative w-full h-80 rounded-lg overflow-hidden shadow-sm bg-gray-900">
                  <video
                    ...
                    preload="metadata"
                  >
                    <source src="/images/job-1-video.mp4" type="video/mp4" />
              ...
              <div className="lg:col-span-1 space-y-8">
                ...
                <div className="relative w-full h-80 rounded-lg overflow-hidden shadow-sm bg-gray-900">
                  <video
                    ...
                    preload="metadata"
                  >
                    <source src="/images/job-4-video.mp4" type="video/mp4" />
                    Your browser does not support the video tag.
                  </video>
                </div>
              </div>
              ...
              <div className="lg:col-span-1 space-y-8">
                ...
                <div className="relative w-full h-80 rounded-lg overflow-hidden shadow-sm bg-gray-900">
                  <video
                    ...
                    preload="metadata"
                  >
                    <source src="/images/job-2-video.mp4" type="video/mp4" />
                    Your browser does not support the video tag.
                  </video>
                </div>
              </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
              ...
              <div className="lg:col-span-1 flex flex-col justify-between space-y-4 h-full">
                ...
                <div className="relative w-full h-40 rounded-lg overflow-hidden shadow-sm">
                  <Image
                    src="/images/food-sleeve-flat.JPG"
                ...
                <div className="relative w-full h-40 rounded-lg overflow-hidden shadow-sm">
                  <Image
                    src="/images/4-creases-black.jpg"
                ...
                <div className="relative w-full h-40 rounded-lg overflow-hidden shadow-sm">
                  <Image
                    src="/images/food-sleeve-finished.JPG"
